...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Недавние таблицы" class="drop_button btn">Недавнее</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hkbase&table=help">`hkbase`.`help`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hkbase&table=like">`hkbase`.`like`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hkbase&table=product">`hkbase`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hkbase&table=user">`hkbase`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hkbase&table=comment">`hkbase`.`comment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crudsystem&table=product">`crudsystem`.`product`</a></li></ul></div><div class="drop_list"><button title="Избранные таблицы" class="drop_button btn">Избранное</button><ul id="pma_favorite_list"><li class="warp_link">Нет избранных таблиц.</li></ul></div><div class="clearfloat"></div></div>
