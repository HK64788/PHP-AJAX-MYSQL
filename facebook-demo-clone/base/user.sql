...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1002956093ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Недавние таблицы" class="drop_button btn">Недавнее</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hkbase&table=user">`hkbase`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hkbase&table=comment">`hkbase`.`comment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hkbase&table=help">`hkbase`.`help`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hkbase&table=like">`hkbase`.`like`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hkbase&table=product">`hkbase`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crudsystem&table=product">`crudsystem`.`product`</a></li></ul></div><div class="drop_list"><button title="Избранные таблицы" class="drop_button btn">Избранное</button><ul id="pma_favorite_list"><li class="warp_link">Нет избранных таблиц.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="506c6c2a652b3c522978447e78576a64">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Нажмите Enter для выполнения запроса                    </span>
                            ...
                            targetdb="crudsystem" targettable="product">
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `product`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="hkbase" targettable="product">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `product`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="hkbase" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `product`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="hkbase" targettable="like">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `like`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="hkbase" targettable="help">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `help`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="hkbase" targettable="comment">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
